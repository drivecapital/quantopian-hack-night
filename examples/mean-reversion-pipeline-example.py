...
def make_pipeline(context):
    ...
    # Create a recent_returns factor with a 5-day returns lookback for all 
    # securities in our high_dollar_volume Filter. This is a custom factor 
    # defined below (see RecentReturns class).
